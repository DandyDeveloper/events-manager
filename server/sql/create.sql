...
INSERT INTO users (name, password, email, group_id) VALUES ('Dandy Inc.', sha1('password'), 'Dandy@test.com', 2);
...
INSERT INTO users (name, password, email, group_id) VALUES ('Jarls Fernando', sha1('password'), 'user2@test.com', 1);
INSERT INTO users (name, password, email, group_id) VALUES ('CocoFandango', sha1('password'), 'user3@test.com', 1);

INSERT INTO events (user_id, name, start_date) VALUES (1, 'Dandy Event1', '2015-04-17 19:00:00');
INSERT INTO events (user_id, name, start_date) VALUES (1, 'Dandy Event2', '2015-04-19 19:00:00');
